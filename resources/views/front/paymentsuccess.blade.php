...
<div class="container">
    <div class="row text-center">
        <div class="col-sm-6 col-sm-offset-3">
            ...
            <h3>Cher(e), {{$user->fname}} {{$user->lname}}</h3>
            <p style="font-size:20px;color:#5C5C5C;">Merci pour le paiement, nous vous avons envoyé un email "{{$user->email}}" avec votre numéro de billet.
            </p>
